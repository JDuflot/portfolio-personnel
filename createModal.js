export default function createModal(){
    ...
    <style>
      ...
      .modal {
        ...
        place-items: center;
        overflow: hidden;
        box-shadow: 0px 2px 40px hsl(var(--hue) 70% 3%);
      }
      ...
      .modal__btn {
        display: grid;
        place-items: center;
        background-color: hsl(var(--hue) 50% 96% / .5);
        color: hsl(var(--hue) 70% 9%);
        padding: .5rem;
      ...
      .modal__btn:is(:hover,:focus) {
        background-color: hsl(var(--hue) 50% 96% / .7);
        border: 4px solid hsl(var(--hue) 50% 96% / .8);
      }
      ...
      .modal__indicator {
        ...
        height: 1rem;
        border-radius: 50%;
        background-color: hsl(var(--hue) 50% 96% );
        border: 3px solid #0F274F;
        cursor: pointer;
        position: relative;
      }
      ...
      .modal__indicator:is(:hover, :focus) {
        background-color: hsl(var(--hue) 50% 96% / .5);
        border: 3px solid hsl(var(--hue) 50% 96% / .7);
      }
